...
const MovieInformation = () => {
  ...
  return (
    <Grid container className={classes.containerSpaceAround}>
      <Grid item sm={12} lg={4} style={{ textAlign: 'center', marginBottom: '30px' }}>
        <img
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item className={classes.containerSpaceAround}>
          ...
          <Typography variant="subtitle1" gutterBottom align="center">
            Language: {data?.spoken_languages[0].name} / Duration: {data?.runtime}min
          </Typography>
        </Grid>
        ...
        <Grid item container style={{ marginTop: '2rem' }}>
          <div className={classes.buttonsContainer}>
            ...
            <Grid item xs={12} sm={6} className={classes.buttonsContainer}>
              <ButtonGroup size="medium" variant="outlined" color="error">
      ...
      <Box marginTop="5rem" width="100%">
        ...
        {recommendations ? <MovieList movies={recommendations} numberOfMovies={15} /> : <Box>Sorry nothing was found.</Box>}
      </Box>
